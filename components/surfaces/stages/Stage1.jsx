            ...
            <View style={styles.container}>
                    ...
                    <Svg width={scaledWidth + 20} height={scaledLength + 20}>
                        <Defs>
                            <Marker
                                ...
                                orient="auto"
                            >
                                <Path d="M0,0 L6,3 L0,6" fill="none" stroke="black" strokeWidth={strokeWidth} />
                            </Marker>
                        </Defs>
                ...
                <View style={styles.formContainer}>
                    ...
                    {selectedShape === "Прямокутник" ? (
                                ...
                                {["Підлога", "Стіна"].map((surface) => (
                                    <DarkButton
                                        ...
                                        style={{
                                            ...
                                            backgroundColor: selectedSurface === surface ? "#333333" : "#ccc",
                                        }}
                                    >
                                        {surface}
                                    </DarkButton>
                        ...
                        <Txt style={styles.placeholderText}>
