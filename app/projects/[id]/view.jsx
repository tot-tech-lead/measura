...
export default function ViewProject() {
    ...
    if (!projectInfo) {
        return (
            <View style={styles.deletedContainer}>
                <Txt style={styles.deletedText}>
                    Проєкт видалено або не знайдено.
                </Txt>
            </View>
        );
    }
    ...
    const filteredAdditionalServices = AdditionalServices.filter((obj) => projectInfo.services.includes(obj.id));
    ...
    return (
        <ViewWithDoubleBackground>
            <ScrollView style={styles.container}>
                ...
                <View style={styles.infoContainer}>
                    ...
                    <Txt style={styles.text}>
                        Опис: <Txt style={styles.textBold}>{projectInfo.description || "Немає опису"}</Txt>
                    </Txt>
                    ...
                    <View style={styles.calculationsContainer}>
                        <Txt style={styles.text}>
                            Площа плитки: <Txt style={styles.textBold}>{calculated.tileArea.toFixed(4)} м²</Txt>
                        </Txt>
                        ...
                        <Txt style={styles.text}>
                            Вартість послуг: <Txt style={styles.textBold}>{calculated.workPrice.toFixed(2)} ₴</Txt>
                        </Txt>

                        <Txt style={styles.text}>
                            Вартість додаткових послуг: <Txt style={styles.textBold}>
                            { calculated.additionalPrice === 0 ? (
                            <Txt style={styles.textBold}>-</Txt>
                        ) : (
                            <Txt style={styles.textBold}>{calculated.additionalPrice.toFixed(2)} ₴</Txt>
                        )
                            }
                        </Txt>
                        </Txt>
            ...
            <View style={styles.buttonContainer}>
                ...
                {/* Додаткові кнопки */}
                <Animated.View style={[styles.button, { transform: [{ translateY: button1TranslateY }] }]}>
                    <RoundButton
                        iconSource={require("../../../assets/images/card/bill.png")}
                        onPress={() => router.navigate(`/projects/${projectInfo.id}/pricelist`)}
                    />
                </Animated.View>

                <Animated.View style={[styles.button, { transform: [{ translateY: button2TranslateY }] }]}>
                    <RoundButton
                ...
                <Animated.View style={[styles.button, { transform: [{ translateY: button3TranslateY }] }]}>
                    <RoundButton
        ...
        >
            <View style={styles.modalOverlay}>
                <View style={styles.modalContent}>
                    ...
                    <Txt style={styles.modalText}>Ви впевнені що хочете видалити проект {projectInfo.name}?
